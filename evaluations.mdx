...
The evaluation detail page includes an **Annotations** tab for human review and an **Annotation Calibration** tab showing agreement rates between the LLM judge and human reviewers. See [Annotations](/annotations) for full details.
