...
**Type-specific config** — For quantitative metrics, set the score range (e.g. 0–5 or 0–1). For qualitative metrics, define the label options the judge can assign.
