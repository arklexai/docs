...
<Frame>
  ![The built-in metrics list on the Metrics page](/images/metrics-built-in.png)
</Frame>
...
<Frame>
  ![The custom metric creation form](/images/metrics-custom.png)
</Frame>
...
<Frame>
  ![The metric selector grouped into custom and built-in types](/images/metrics-types.png)
</Frame>
