...
| Pending | <span style={{display:'inline-block', width:'12px', height:'12px', borderRadius:'3px', background:'#9ca3af', marginRight:'6px'}}></span> Gray |
...
- **Delete agent** — a destructive action at the bottom of the form. Deletion is blocked if any simulations or evaluations still reference this agent. Delete those first, then return here to delete the agent. A confirmation dialog appears before the final deletion.
