...
Click any document row to open the document detail page. The detail view shows the document content and metadata. Documents that fail to process show an error message with guidance on supported formats.
...
Click **Add Website** and enter the URL to crawl. Arkdock fetches and indexes the page content. For multi-page documentation sites, you can add individual page URLs.
...
Click any website row to open the link detail page, which shows the indexed content and metadata.
...
<AccordionGroup>
  ...
  <Accordion title="Does adding a website crawl linked pages?">
    Currently Arkdock indexes the specific URL you provide, not a full site crawl. Add individual URLs for each page you want available.
  </Accordion>
